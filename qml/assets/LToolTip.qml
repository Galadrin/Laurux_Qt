// thank's to henrythasler for the tooltip asset
// https://github.com/henrythasler/pwnsensor/blob/master/qml/pwnsensor/Assets/Tooltip.qml
...
Item {
    ...
    //this makes it easy to have custom hide delays
    //for different tools
