...
ApplicationWindow {
    ...
    color: Coulfonds.background

    property Component button_style: ButtonStyle {
        background: Rectangle {
            color: Btns.background
        }
        Text {
            font.family: Btns.fontName
            font.pixelSize: Btns.fontSize
        }
    }
    ...
    toolBar: ToolBar {
        RowLayout {
            anchors.fill: parent
            ToolButton { id: client_table_button
                style: button_style

                tooltip: qsTr("Table des clients")
                iconSource: "qrc:/icons/22x22/Client.png"
            }
            Item { Layout.fillWidth: true }
            ToolButton { id: exit_button
                style: button_style

                tooltip: qsTr("Quitter")
                iconSource: "qrc:/icons/22x22/exit.png"
            }
        }
    }
